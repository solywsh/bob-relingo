...
def update_appcast(message):
    ...
    release_file = Path(f"release/bob-relingo.bobplugin")
    ...
    version_info = {
        ...
        "desc": message,
        "sha256": file_hash,
        "url": f"https://github.com/solywsh/bob-relingo/releases/download/v{version}/bob-relingo_v{version}.bobplugin",
        "minBobVersion": "0.5.0"
    }
    ...
    if appcast_file.is_file():
        ...
        appcast = dict(identifier="com.solywsh.bob.relingo", versions=[])
